"""Execute one bounded, unchanged C23 Linux replication on a Secure CPU pod."""
...
OUT = HERE / "runpod-c23-linux-execute-001"
...
def run() -> int:
    ...
    try:
        ...
        if not ready["ready"] or not ready["c23_budget"]["ready"] or any(ready["inventories"].values()):

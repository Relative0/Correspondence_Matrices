"""Independently verify the bounded single-pod C23 Linux replication."""
...
OUTPUT = HERE / "RUNPOD_C23_FINAL_VERIFICATION_20260831.json"
METHODS = {
    "cm_exhaustive",
    "cm_screened",
...
def main() -> None:
    ...
    output = {
        "schema": "crse-runpod-c23-final-verification/v1",
        "status": "pass",
        "complete": True,

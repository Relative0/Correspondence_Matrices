"""Independently verify successful retry 002 of the C23 Linux replication."""
...
RUN_DIR = HERE / "runpod-c23-linux-execute-002"
...
OUTPUT = HERE / "RUNPOD_C23_RETRY_002_FINAL_VERIFICATION_20260831.json"
METHODS = {
    "cm_exhaustive",
    "cm_screened",
...
def main() -> None:
    ...
    output = {
        "schema": "crse-runpod-c23-retry-002-final-verification/v1",
        "status": "pass",
        "complete": True,

...
OUT = HERE / "runpod-c31-linux-execute-002"
MANIFEST = HERE / "c31_linux_upload_manifest.json"
AUTHORIZATION = HERE / "RUNPOD_C31_TRANSPORT_RETRY_001_AUTHORIZED_2026_09_01.json"
...
def run() -> int:
    ...
    try:
        ...
        created = time.time()
        # The inherited, independently tested watchdog owns this historical
        # namespace. The scientific payload and C31 run name remain unchanged.

# Architecture-aware four-lane comparison execution protocol

This package executes the verified parent freeze without changing its selected
cases, arm orders, or publication gates. It creates 19,646
...
verifier must replay the oracle set, verify all 19,646

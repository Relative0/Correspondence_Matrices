...
& "$ivc\venv\Scripts\ivc.exe" render `
  'docs\video_factory\proofs\cm-ir-vs-cse-flat\assembly.spec.json' `
  --out 'docs\video_factory\proofs\cm-ir-vs-cse-flat\ivc-output' --json
```

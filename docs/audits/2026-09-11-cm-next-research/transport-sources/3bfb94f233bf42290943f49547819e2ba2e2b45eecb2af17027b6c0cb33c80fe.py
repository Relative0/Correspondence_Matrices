...
OUT = RUN_DIR / "runpod-second-host-physical-002-003"
PRIOR_PRELAUNCH_FAILURE = (
    RUN_DIR / "runpod-second-host-physical-002-001/PRELAUNCH_FAILURE.json"
)
PRIOR_FAILED_RUN = RUN_DIR / "runpod-second-host-physical-002-002/RUN.json"
BUNDLE = RUN_DIR / "SECOND_HOST_SOURCE_BUNDLE_V3.zip"
V3_MANIFEST = RUN_DIR / "SECOND_HOST_SOURCE_BUNDLE_V3_MANIFEST.json"
V3_LOCAL_VALIDATION = RUN_DIR / "SECOND_HOST_SOURCE_BUNDLE_V3_LOCAL_VALIDATION.json"
HANDOFF = RUN_DIR / "SECOND_HOST_HANDOFF.json"
AUTHORIZATION = RUN_DIR / "RUNPOD_SECOND_HOST_V3_AUTHORIZATION_20260910.json"
...
EXPECTED_BUNDLE_BYTES = 1_815_934
EXPECTED_BUNDLE_SHA256 = (
    "04703c8afaa2afd0cfaf77c7b387883dc9a8c3a192f73afe3fc094a913aedacb"
)
...
BUNDLE_SHA256 = '04703c8afaa2afd0cfaf77c7b387883dc9a8c3a192f73afe3fc094a913aedacb'
...
def require_authorization() -> dict:
    ...
    expected = {
        "schema": "crse-query-ladder-q64-runpod-second-host-v3-authorization/v1",
        "authorized": True,
        ...
        "prior_failed_run_sha256": sha256(PRIOR_FAILED_RUN),
        "v3_manifest_sha256": sha256(V3_MANIFEST),
        "v3_local_validation_sha256": sha256(V3_LOCAL_VALIDATION),
    }
    ...
    if (
        ...
        or handoff.get("current_package", {}).get("sha256")
        ...
        or load(PRIOR_FAILED_RUN).get("status") != "failed"
        or load(PRIOR_FAILED_RUN).get("cleanup", {}).get("owned_pod_absent") is not True
        or load(V3_MANIFEST).get("sha256") != EXPECTED_BUNDLE_SHA256
        or load(V3_MANIFEST).get("status") != "sealed_not_authorized_for_upload"
        or load(V3_LOCAL_VALIDATION).get("status") != "pass"
        or load(V3_LOCAL_VALIDATION).get("timing_results_opened") is not False

...
3. Corrected B2/B4 evidence adds a workload-specific structural result, not a universal one: bare CM/CSE-flat `0.909` overall and `0.979` at `k=16`; public wrapper/CSE-flat `2.797` overall and `1.343` at `k=16`.

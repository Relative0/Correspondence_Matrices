"""One read-only inventory snapshot for the ambiguous CPU8 creation request."""
...
ATTEMPT = ROOT / "cpu8-execute-001"
spec = importlib.util.spec_from_file_location("cpu8_controller", ROOT / "runpod_retry_cpu8_controller.py")

"""One separately authorized chunked retry of the comparative native scout."""
import argparse
import base64
...
OUT = HERE / "http-native-scout-chunked-retry-execute-001"
...
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-SCOUT-CHUNKED-RETRY-PROPOSAL-20260829.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-SCOUT-CHUNKED-RETRY-AUTHORIZED-20260829.json"

"""Build the exact deterministic W8 V3 conversion-scout upload bundle."""
...
WORKER = HERE / "runpod_w8_logikbench_conversion_worker_v3.py"
...
def main() -> int:
    ...
    manifest = {
        "schema": "cm-runpod-w8-logikbench-conversion-upload-manifest/v3",

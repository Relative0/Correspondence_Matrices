"""One-create V12 native-gap campaign scout under the aggregate-cost authority."""
import argparse
import base64
...
import requests
import http_native_scout_preflight_v12 as preflight

HERE = Path(__file__).resolve().parent
TRANSPORT = HERE.parent / "runpod-authorized-20260827-213104"
OUT = HERE / "native-gap-v12-001"
...
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-GAP-CAMPAIGN-V12-AUTHORITY-RECONCILIATION-20260829.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-GAP-CAMPAIGN-V12-AUTHORIZED-20260829.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-native-gap-campaign-v12-authorization/v1",
        "authorized": True,
        "one_create": True,
        "no_replacement": True,
        "source_files": 37,

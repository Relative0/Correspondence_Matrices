"""One-create V3 retry of native persistence with complete public build dependencies."""
import argparse
import base64
...
import requests
import http_native_persistence_preflight_v3 as preflight

HERE = Path(__file__).resolve().parent
TRANSPORT = HERE.parent / "runpod-authorized-20260827-213104"
OUT = HERE / "native-persistence-v3-001"
...
REMOTE_CODE_PATH = HERE / "runpod_native_persistence_remote_v3.py"
...
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-PERSISTENCE-CAMPAIGN-V3-RETRY-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-PERSISTENCE-CAMPAIGN-V3-AUTHORIZED-20260830.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-native-persistence-campaign-v3-authorization/v1",
        "authorized": True,
        "one_create": True,
        "no_replacement_within_this_controller": True,
        "retry_number": 2,
        "external_source_upload_approved": True,
        "prior_native_persistence_pod_id": "odcer7ilz59smo",
        "source_files": 136,
...
def save_evidence(log):
    ...
    try:
        ...
        d4_build = load(evidence_root / "D4-BUILD.json")
    ...
    if (
        validation.get("junit_testcases") != {"tests": 24, "failures": 0, "errors": 0, "skipped": 0}
        or type(junit_metadata.get("tests")) is not int
        or junit_metadata.get("tests", 0) < 24
        ...
        or patoh_header != {
            ...
            "sha256": "60e00eabe484f67f6efefa6747e4d4e218322e5a454ab3b6eac70a041afbd3bc",

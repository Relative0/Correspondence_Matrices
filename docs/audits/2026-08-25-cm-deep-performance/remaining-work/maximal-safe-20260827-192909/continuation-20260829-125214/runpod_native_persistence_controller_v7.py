"""One-create V7 unchanged retry after a fail-closed procfs sampling race."""
import argparse
import base64
...
import requests
import http_native_persistence_preflight_v7 as preflight

HERE = Path(__file__).resolve().parent
TRANSPORT = HERE.parent / "runpod-authorized-20260827-213104"
OUT = HERE / "native-persistence-v7-001"
...
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-PERSISTENCE-CAMPAIGN-V7-RETRY-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-PERSISTENCE-CAMPAIGN-V7-AUTHORIZED-20260830.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-native-persistence-campaign-v7-authorization/v1",
        "authorized": True,
        "one_create": True,
        "no_replacement_within_this_controller": True,
        "retry_number": 6,
        "external_source_upload_approved": True,
        "prior_native_persistence_pod_id": "7ucx4lcpvaj8j6",
        "source_files": 136,

...
SHARDS = {
    "relation-development-b-light": {"policy": "p7-relation", "role": "development"},
}
SHARD_ID = "relation-development-b-light"
CASE_OFFSET = 17
CASE_LIMIT = 15
...
try:
    ...
    parent_freeze_path = ROOT / "docs/research/verification/comparative-p6-candidate-v4-2026-08-30/freeze.json"

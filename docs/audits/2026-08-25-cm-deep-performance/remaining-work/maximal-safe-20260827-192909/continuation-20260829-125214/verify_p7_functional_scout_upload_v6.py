...
MANIFEST = HERE / "RUNPOD-P7-FUNCTIONAL-SCOUT-UPLOAD-MANIFEST-V6-20260830.json"
BUNDLE = HERE / "RUNPOD-P7-FUNCTIONAL-SCOUT-UPLOAD-BUNDLE-V6-20260830.zip"
RESULT = HERE / "P7-FUNCTIONAL-SCOUT-UPLOAD-V6-LOCAL-GATE-20260830.json"
JUNIT = HERE / "P7-FUNCTIONAL-SCOUT-UPLOAD-V6-LOCAL-GATE-20260830.xml"
TESTS = [
...
def main() -> None:
    ...
    with zipfile.ZipFile(BUNDLE) as archive:
        ...
        with tempfile.TemporaryDirectory(prefix="cm-p7-upload-v6-") as temporary:
            root = Path(temporary)
            ...
            gate = subprocess.run(
                [
                    ...
                    "--output",
                    str(root / "docs/research/verification/comparative-p7-offline-gate-v4-2026-08-30"),
                ],
                cwd=root,
                env=environment,
                capture_output=True,
    ...
    result = {
        "schema": "cm-p7-functional-scout-upload-v6-local-gate/v1",
        ...
        "offline_gate_returncode": gate.returncode,
        "offline_gate_stdout": gate.stdout,
        "offline_gate_stderr": gate.stderr,
        "passed": completed.returncode == 0 and gate.returncode == 0,
    }
    RESULT.write_text(json.dumps(result, indent=2) + "\n", encoding="utf-8", newline="\n")
    print(json.dumps(result, indent=2))
    if completed.returncode or gate.returncode:
        raise SystemExit(completed.returncode or gate.returncode)

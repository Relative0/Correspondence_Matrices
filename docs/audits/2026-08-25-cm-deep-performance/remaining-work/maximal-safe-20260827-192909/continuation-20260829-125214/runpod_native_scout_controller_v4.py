"""One separately authorized dependency-closed comparative native scout."""
import argparse
import base64
...
import requests
import http_native_scout_preflight_v4 as preflight

HERE = Path(__file__).resolve().parent
TRANSPORT = HERE.parent / "runpod-authorized-20260827-213104"
OUT = HERE / "http-native-scout-closure-retry-execute-001"
...
REMOTE_CODE_PATH = HERE / "runpod_native_scout_remote_v2.py"
...
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-SCOUT-CLOSURE-RETRY-PROPOSAL-20260829.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-SCOUT-CLOSURE-RETRY-AUTHORIZED-20260829.json"
...
def save_evidence(log):
    ...
    if (
        ...
        or smoke.get("observed_cells") != 144
        or smoke.get("statuses") != {"ok": 144}

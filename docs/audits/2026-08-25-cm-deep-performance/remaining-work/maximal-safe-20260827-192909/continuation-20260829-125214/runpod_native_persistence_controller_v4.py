"""One-create V4 retry with canonical upstream PaToH blob identity."""
import argparse
import base64
...
import requests
import http_native_persistence_preflight_v4 as preflight

HERE = Path(__file__).resolve().parent
TRANSPORT = HERE.parent / "runpod-authorized-20260827-213104"
OUT = HERE / "native-persistence-v4-001"
...
REMOTE_CODE_PATH = HERE / "runpod_native_persistence_remote_v4.py"
...
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-PERSISTENCE-CAMPAIGN-V4-RETRY-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-PERSISTENCE-CAMPAIGN-V4-AUTHORIZED-20260830.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-native-persistence-campaign-v4-authorization/v1",
        "authorized": True,
        "one_create": True,
        "no_replacement_within_this_controller": True,
        "retry_number": 3,
        "external_source_upload_approved": True,
        "prior_native_persistence_pod_id": "cgazict5szhbg5",
        "source_files": 136,

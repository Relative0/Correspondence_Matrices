"""One-create controller for one exact-96 P7 W3 correctness shard."""
import argparse
import base64
...
REMOTE_CODE_PATH = HERE / "runpod_p7_w3_shard_remote_v1.py"
...
PROPOSAL_PATH = HERE / "RUNPOD-P7-W3-SHARDED-RETRY-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / ("HTTP-P7-W3-SHARD-" + SHARD_ID.upper() + "-AUTHORIZED-20260830.json")
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-p7-w3-shard-authorization/v1",
        "authorized": True,
        "one_create": True,
        ...
        "prior_attempt_pod_ids": ["1xh6csc4oxy067", "2fzt8mu6ji6nmw", "r044pqp2vgp7cy", "6mlqn19hnco1b0", "d9z39u7pzvbju8"],

"""One separately authorized procfs-race-corrected comparative native scout."""
import argparse
import base64
...
import requests
import http_native_scout_preflight_v6 as preflight

HERE = Path(__file__).resolve().parent
TRANSPORT = HERE.parent / "runpod-authorized-20260827-213104"
OUT = HERE / "http-native-scout-procfs-race-retry-execute-001"
...
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-SCOUT-PROCFS-RACE-RETRY-PROPOSAL-20260829.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-SCOUT-PROCFS-RACE-RETRY-AUTHORIZED-20260829.json"
...
def run():
    ...
    try:
        ...
        if (len(manifest["files"]) != 37 or manifest.get("bytes") != 5500977

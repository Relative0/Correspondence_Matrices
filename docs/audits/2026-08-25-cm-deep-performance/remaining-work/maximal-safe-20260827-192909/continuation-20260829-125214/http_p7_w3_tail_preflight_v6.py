"""Read-only sequential preflight for the final W3 development tail."""
...
SHARDS = {
    "ir-development-b-light": {"output": "p7-w3-tail-ir-development-b-light-v6-001", "cells": 60},
    "ir-development-sqrt": {"output": "p7-w3-tail-ir-development-sqrt-v6-001", "cells": 4},
    "ir-development-square": {"output": "p7-w3-tail-ir-development-square-v6-001", "cells": 4},
    "relation-development-a": {"output": "p7-w3-tail-relation-development-a-v6-001", "cells": 85},
    "relation-development-b-light": {"output": "p7-w3-tail-relation-development-b-light-v6-001", "cells": 75},
    "relation-development-sqrt": {"output": "p7-w3-tail-relation-development-sqrt-v6-001", "cells": 5},
    "relation-development-square": {"output": "p7-w3-tail-relation-development-square-v6-001", "cells": 5},
}
ORDER = tuple(SHARDS)
...
def check():
    ...
    fixed = (monolith, transport, ir_regression, ir_development_timeout, relation_regression, ir_development_a, ir_development_b_timeout)
    ...
    try:
        ...
        client.close()
    if current != {"v1": [], "v2": []}:
        raise RuntimeError("nonempty RunPod inventory before final W3 development-tail partition")

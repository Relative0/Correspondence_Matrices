"""One-create V13 native-gap scout with fenced external d4 children."""
import argparse
import base64
...
import requests
import http_native_gap_preflight_v13 as preflight

HERE = Path(__file__).resolve().parent
TRANSPORT = HERE.parent / "runpod-authorized-20260827-213104"
OUT = HERE / "native-gap-v13-001"
...
MANIFEST_PATH = HERE / "RUNPOD-NATIVE-SCOUT-UPLOAD-MANIFEST-V9-20260829.json"
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-GAP-CAMPAIGN-V13-D4-FENCE-PROPOSAL-20260829.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-GAP-CAMPAIGN-V13-AUTHORIZED-20260829.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-native-gap-campaign-v13-authorization/v1",
        "authorized": True,
        "one_create": True,
        "no_replacement": True,
        "source_files": 37,
        ...
        "prior_failed_pod_ids": [
            ...
            "pow0qre2q39m4t", "3o7r0za7cm72yn", "jwyi342sjmjkcj", "kvpu2s8ozs7j27", "omsz7w8fmlhqn0"
        ],
...
def run():
    ...
    try:
        ...
        if (len(manifest["files"]) != 37 or manifest.get("bytes") != 5508763

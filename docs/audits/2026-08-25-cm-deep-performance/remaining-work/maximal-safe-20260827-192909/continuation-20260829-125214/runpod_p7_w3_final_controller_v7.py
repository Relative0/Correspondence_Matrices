"""V7 one-create controller for one remaining exact-96 P7 W3 correctness partition."""
import argparse
import base64
...
import requests
import http_p7_w3_final_preflight_v7 as preflight

HERE = Path(__file__).resolve().parent
SHARDS = {
    "ir-development-square": {"policy": "p7-ir", "role": "development", "cases": 1, "cells": 4,
                              "offset": 33, "limit": 1, "code": "irsqr", "out": "p7-w3-final-ir-development-square-v7-001",
    ...
    "relation-development-a": {"policy": "p7-relation", "role": "development", "cases": 17, "cells": 85,
                               "offset": 0, "limit": 17, "code": "rda", "out": "p7-w3-final-relation-development-a-v7-001",
    ...
    "relation-development-b-light": {"policy": "p7-relation", "role": "development", "cases": 15, "cells": 75,
                                     "offset": 17, "limit": 15, "code": "rdl", "out": "p7-w3-final-relation-development-b-light-v7-001",
    ...
    "relation-development-square": {"policy": "p7-relation", "role": "development", "cases": 1, "cells": 5,
                                    "offset": 33, "limit": 1, "code": "rdsqr", "out": "p7-w3-final-relation-development-square-v7-001",
                                    "remote": "runpod_p7_w3_tail_remote_v6_relation_development_square.py"},
}
SHARD_ID = os.environ.get("CM_W3_SPLIT_ID")
if SHARD_ID not in SHARDS:
    raise RuntimeError("CM_W3_SPLIT_ID must name one remaining W3 completion partition")
SHARD = SHARDS[SHARD_ID]
SHARD["name_prefix"] = "cm-p7-w3s7-" + SHARD["code"]
...
PROPOSAL_PATH = HERE / "RUNPOD-P7-W3-FINAL-V7-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / ("HTTP-P7-W3-FINAL-" + SHARD_ID.upper() + "-V7-AUTHORIZED-20260830.json")
...
def require_authorization():
    ...
    expected = {
        ...
        "prior_attempt_pod_ids": ["1xh6csc4oxy067", "2fzt8mu6ji6nmw", "r044pqp2vgp7cy", "6mlqn19hnco1b0", "d9z39u7pzvbju8", "pnpc0c0t6gu358", "9xjz22tif2ctrv", "alu08d0mlf02ba", "1uqsgeb7vpzihb", "dop3aggj7vsefp", "b5ju67cawznkfj", "wtvtfqt2kamwax"],

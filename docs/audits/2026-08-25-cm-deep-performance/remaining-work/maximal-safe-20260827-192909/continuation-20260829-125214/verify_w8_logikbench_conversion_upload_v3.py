"""Offline verification for the exact W8 LogikBench conversion V3 upload."""
...
MANIFEST = HERE / "RUNPOD-W8-LOGIKBENCH-CONVERSION-UPLOAD-MANIFEST-V3-20260830.json"
BUNDLE = HERE / "RUNPOD-W8-LOGIKBENCH-CONVERSION-UPLOAD-BUNDLE-V3-20260830.zip"
EXPECTED_MANIFEST_SHA256 = "f908473b2e4df15ac7ca3b88c82e219c5e33c068022a9074d763604968190d98"
EXPECTED_BUNDLE_SHA256 = "be42ee3517167e83168b138e8607eeebf5c6cc66d6660167daa2b38b425277b3"
...
def verify() -> dict:
    ...
    if (
        ...
        or manifest.get("private_project_files") != [
            "runpod_w8_logikbench_conversion_worker_v3.py",

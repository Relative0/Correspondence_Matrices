"""One-create V14 native-gap scout with fenced external d4 children."""
import argparse
import base64
...
import requests
import http_native_gap_preflight_v14 as preflight

HERE = Path(__file__).resolve().parent
TRANSPORT = HERE.parent / "runpod-authorized-20260827-213104"
OUT = HERE / "native-gap-v14-001"
...
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-GAP-CAMPAIGN-V14-RSS-WINDOW-PROPOSAL-20260829.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-GAP-CAMPAIGN-V14-AUTHORIZED-20260829.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-native-gap-campaign-v14-authorization/v1",
        "authorized": True,
        "one_create": True,
        "no_replacement": True,
        "source_files": 37,

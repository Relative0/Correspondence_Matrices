"""Bounded W8 LogikBench conversion scout; executed only by its V2 controller."""
...
ROOT = Path("/workspace/cm-w8-logikbench-conversion-v2")
OUT = ROOT / "run-output"
CAP = 32 << 20
WORKER = ROOT / "runpod_w8_logikbench_conversion_worker_v2.py"

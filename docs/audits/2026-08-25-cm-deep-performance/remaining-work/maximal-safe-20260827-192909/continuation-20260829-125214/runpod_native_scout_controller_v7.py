"""One amended host-preflight-safe procfs-corrected comparative native scout."""
import argparse
import base64
...
MANIFEST_PATH = HERE / "RUNPOD-NATIVE-SCOUT-UPLOAD-MANIFEST-V6-20260829.json"
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-SCOUT-HOST-PREFLIGHT-AMENDMENT-PROPOSAL-20260829.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-SCOUT-HOST-PREFLIGHT-AMENDMENT-AUTHORIZED-20260829.json"
...
def save_evidence(log):
    ...
    if (
        validation.get("junit_testcases") != {"tests": 63, "failures": 0, "errors": 0, "skipped": 0}
        or type(junit_metadata.get("tests")) is not int
        or junit_metadata.get("tests", 0) < 63
...
def run():
    ...
    try:
        ...
        if (len(manifest["files"]) != 37 or manifest.get("bytes") != 5504396

"""V3 one-create controller for the exact-96 P7 W3 relation-regression shard."""
import argparse
import base64
...
SHARDS = {
    "relation-regression": {"policy": "p7-relation", "role": "regression", "cases": 24, "cells": 120,
                            "code": "rr", "out": "p7-w3-shard-relation-regression-v3-001",
...
SHARD["name_prefix"] = "cm-p7-w3s3-" + SHARD["code"]
...
PROPOSAL_PATH = HERE / "RUNPOD-P7-W3-RELATION-REGRESSION-V3-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / "HTTP-P7-W3-RELATION-REGRESSION-V3-AUTHORIZED-20260830.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-p7-w3-shard-authorization/v3",
        "authorized": True,
        "one_create": True,
        ...
        "prior_attempt_pod_ids": ["1xh6csc4oxy067", "2fzt8mu6ji6nmw", "r044pqp2vgp7cy", "6mlqn19hnco1b0", "d9z39u7pzvbju8", "pnpc0c0t6gu358", "9xjz22tif2ctrv", "alu08d0mlf02ba"],

"""V5 one-create controller for one remaining exact-96 P7 W3 development partition."""
import argparse
import base64
...
SHARDS = {
    "ir-development-b": {"policy": "p7-ir", "role": "development", "cases": 17, "cells": 68,
                         "offset": 17, "limit": 17, "code": "irdb", "out": "p7-w3-split-ir-development-b-v5-001",
    ...
    "relation-development-a": {"policy": "p7-relation", "role": "development", "cases": 17, "cells": 85,
                               "offset": 0, "limit": 17, "code": "rda", "out": "p7-w3-split-relation-development-a-v5-001",
    ...
    "relation-development-b": {"policy": "p7-relation", "role": "development", "cases": 17, "cells": 85,
                               "offset": 17, "limit": 17, "code": "rdb", "out": "p7-w3-split-relation-development-b-v5-001",
...
SHARD["name_prefix"] = "cm-p7-w3s5-" + SHARD["code"]
...
PROPOSAL_PATH = HERE / "RUNPOD-P7-W3-DEVELOPMENT-SPLIT-V5-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / ("HTTP-P7-W3-SPLIT-" + SHARD_ID.upper() + "-V5-AUTHORIZED-20260830.json")

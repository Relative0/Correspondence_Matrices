...
MANIFEST = HERE / "RUNPOD-P7-FUNCTIONAL-SCOUT-UPLOAD-MANIFEST-V5-20260830.json"
BUNDLE = HERE / "RUNPOD-P7-FUNCTIONAL-SCOUT-UPLOAD-BUNDLE-V5-20260830.zip"
RESULT = HERE / "P7-FUNCTIONAL-SCOUT-UPLOAD-V5-LOCAL-GATE-20260830.json"
JUNIT = HERE / "P7-FUNCTIONAL-SCOUT-UPLOAD-V5-LOCAL-GATE-20260830.xml"
TESTS = [
...
def main() -> None:
    ...
    with zipfile.ZipFile(BUNDLE) as archive:
        ...
        with tempfile.TemporaryDirectory(prefix="cm-p7-upload-v5-") as temporary:
            root = Path(temporary)
    ...
    result = {
        "schema": "cm-p7-functional-scout-upload-v5-local-gate/v1",

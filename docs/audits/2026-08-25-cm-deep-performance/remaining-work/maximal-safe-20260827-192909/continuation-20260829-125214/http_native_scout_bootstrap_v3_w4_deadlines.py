"""W4-compatible token-gated, bounded, resumable chunk transport.

V3 differs from the preserved V2 bootstrap only by accepting the separately
bounded execution deadline already emitted by the frozen W4 controller and
consumed by its remote program.
"""
import base64
import hashlib
import hmac

"""V2 one-create controller for one exact-96 P7 W3 correctness shard."""
import argparse
import base64
...
SHARDS = {
    "ir-regression": {"policy": "p7-ir", "role": "regression", "cases": 24, "cells": 96,
                      "code": "irr", "out": "p7-w3-shard-ir-regression-v2-001",
                      "remote": "runpod_p7_w3_shard_remote_v2_ir_regression.py"},
    "ir-development": {"policy": "p7-ir", "role": "development", "cases": 34, "cells": 136,
                       "code": "ird", "out": "p7-w3-shard-ir-development-v2-001",
                       "remote": "runpod_p7_w3_shard_remote_v2_ir_development.py"},
    "relation-regression": {"policy": "p7-relation", "role": "regression", "cases": 24, "cells": 120,
                            "code": "rr", "out": "p7-w3-shard-relation-regression-v2-001",
                            "remote": "runpod_p7_w3_shard_remote_v2_relation_regression.py"},
    "relation-development": {"policy": "p7-relation", "role": "development", "cases": 34, "cells": 170,
                             "code": "rd", "out": "p7-w3-shard-relation-development-v2-001",
                             "remote": "runpod_p7_w3_shard_remote_v2_relation_development.py"},
}
SHARD_ID = os.environ.get("CM_W3_SHARD_ID")
if SHARD_ID not in SHARDS:
    raise RuntimeError("CM_W3_SHARD_ID must name one frozen W3 shard")
SHARD = SHARDS[SHARD_ID]
SHARD["name_prefix"] = "cm-p7-w3s2-" + SHARD["code"]
...
PROPOSAL_PATH = HERE / "RUNPOD-P7-W3-SHARDED-RETRY-V2-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / ("HTTP-P7-W3-SHARD-" + SHARD_ID.upper() + "-V2-AUTHORIZED-20260830.json")
...
def require_authorization():
    ...
    expected = {
        ...
        "prior_attempt_pod_ids": ["1xh6csc4oxy067", "2fzt8mu6ji6nmw", "r044pqp2vgp7cy", "6mlqn19hnco1b0", "d9z39u7pzvbju8", "pnpc0c0t6gu358"],

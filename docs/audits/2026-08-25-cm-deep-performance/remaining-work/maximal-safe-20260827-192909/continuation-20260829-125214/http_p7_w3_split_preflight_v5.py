"""Read-only preflight after the V4 unrelated-inventory no-create refusal."""
...
SHARDS = {
    "ir-development-b": {"output": "p7-w3-split-ir-development-b-v5-001", "cells": 68},
    "relation-development-a": {"output": "p7-w3-split-relation-development-a-v5-001", "cells": 85},
    "relation-development-b": {"output": "p7-w3-split-relation-development-b-v5-001", "cells": 85},
}
ORDER = tuple(SHARDS)
SHARD_ID = os.environ.get("CM_W3_SPLIT_ID")
if SHARD_ID not in SHARDS:
    raise RuntimeError("CM_W3_SPLIT_ID must name one remaining W3 development partition")
...
def check():
    ...
    fixed = (monolith, transport, ir_regression, ir_development_timeout, relation_regression, ir_development_a)
    ...
    try:
        ...
        client.close()
    if current != {"v1": [], "v2": []}:
        raise RuntimeError("nonempty RunPod inventory before remaining W3 development partition")

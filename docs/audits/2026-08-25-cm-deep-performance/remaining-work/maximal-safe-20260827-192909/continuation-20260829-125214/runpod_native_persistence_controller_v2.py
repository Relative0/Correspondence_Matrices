"""One-create V2 retry of native persistence with corrected project-root import binding."""
import argparse
import base64
...
import requests
import http_native_persistence_preflight_v2 as preflight

HERE = Path(__file__).resolve().parent
TRANSPORT = HERE.parent / "runpod-authorized-20260827-213104"
OUT = HERE / "native-persistence-v2-001"
...
REMOTE_CODE_PATH = HERE / "runpod_native_persistence_remote_v2.py"
...
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-PERSISTENCE-CAMPAIGN-V2-RETRY-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-PERSISTENCE-CAMPAIGN-V2-AUTHORIZED-20260830.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-native-persistence-campaign-v2-authorization/v1",
        "authorized": True,
        "one_create": True,
        "no_replacement_within_this_controller": True,
        "retry_number": 1,
        "external_source_upload_approved": True,
        "prior_native_persistence_pod_id": "jof02fgwixhwj8",
        "source_files": 136,
        ...
        "system_packages_allowed": ["build-essential", "libgmp-dev", "zlib1g-dev"],

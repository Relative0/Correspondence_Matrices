"""Verify the corrected upload as an isolated source tree, not the live checkout."""
...
RESULT = HERE / "P7-FUNCTIONAL-SCOUT-UPLOAD-V2-LOCAL-GATE-20260830.json"
JUNIT = HERE / "P7-FUNCTIONAL-SCOUT-UPLOAD-V2-LOCAL-GATE-20260830.xml"
TESTS = [
...
def main() -> None:
    ...
    result = {
        "schema": "cm-p7-functional-scout-upload-v2-local-gate/v1",

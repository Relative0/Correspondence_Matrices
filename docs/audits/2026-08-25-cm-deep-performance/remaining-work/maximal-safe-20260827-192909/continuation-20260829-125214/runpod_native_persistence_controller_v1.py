"""One-create native persistence functional closure with exact replay gates."""
import argparse
import base64
...
import requests
import http_native_persistence_preflight_v1 as preflight

HERE = Path(__file__).resolve().parent
TRANSPORT = HERE.parent / "runpod-authorized-20260827-213104"
OUT = HERE / "native-persistence-v1-001"
...
REMOTE_CODE_PATH = HERE / "runpod_native_persistence_remote_v1.py"
...
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-PERSISTENCE-CAMPAIGN-V1-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-PERSISTENCE-CAMPAIGN-V1-AUTHORIZED-20260830.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-native-persistence-campaign-v1-authorization/v1",
        "authorized": True,
        "one_create": True,

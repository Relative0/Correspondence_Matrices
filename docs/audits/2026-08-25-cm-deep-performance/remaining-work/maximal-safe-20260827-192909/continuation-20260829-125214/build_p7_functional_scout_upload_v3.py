...
NEW_MANIFEST = HERE / "RUNPOD-P7-FUNCTIONAL-SCOUT-UPLOAD-MANIFEST-V3-20260830.json"
NEW_BUNDLE = HERE / "RUNPOD-P7-FUNCTIONAL-SCOUT-UPLOAD-BUNDLE-V3-20260830.zip"
...
def main() -> None:
    ...
    manifest["correction"] = (
        ...
        "referenced by the P7 plan. All 152 V1 payloads remain byte-identical."
    )
    manifest["files"] = rows

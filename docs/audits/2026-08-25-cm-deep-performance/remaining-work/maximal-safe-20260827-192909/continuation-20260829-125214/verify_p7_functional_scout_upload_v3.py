...
MANIFEST = HERE / "RUNPOD-P7-FUNCTIONAL-SCOUT-UPLOAD-MANIFEST-V3-20260830.json"
BUNDLE = HERE / "RUNPOD-P7-FUNCTIONAL-SCOUT-UPLOAD-BUNDLE-V3-20260830.zip"
RESULT = HERE / "P7-FUNCTIONAL-SCOUT-UPLOAD-V3-LOCAL-GATE-20260830.json"
JUNIT = HERE / "P7-FUNCTIONAL-SCOUT-UPLOAD-V3-LOCAL-GATE-20260830.xml"
TESTS = [
...
def main() -> None:
    ...
    result = {
        "schema": "cm-p7-functional-scout-upload-v3-local-gate/v1",

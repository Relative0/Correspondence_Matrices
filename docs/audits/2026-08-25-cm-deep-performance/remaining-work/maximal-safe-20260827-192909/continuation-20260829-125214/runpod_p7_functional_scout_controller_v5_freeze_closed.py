"""One-create all-freeze-source P7 Linux scout after a no-create race."""
import argparse
import base64
...
OUT = HERE / "p7-functional-scout-v5-freeze-closed-001"
...
AUTHORIZATION_PATH = HERE / "HTTP-P7-FUNCTIONAL-SCOUT-V5-FREEZE-CLOSED-AUTHORIZED-20260830.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-p7-functional-scout-v5-freeze-closed-authorization/v1",
        "authorized": True,
        "one_create": True,

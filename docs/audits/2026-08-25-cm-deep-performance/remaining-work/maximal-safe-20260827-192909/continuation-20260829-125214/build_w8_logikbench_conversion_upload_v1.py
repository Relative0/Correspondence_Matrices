"""Build the exact deterministic W8 conversion-scout upload bundle."""
...
REMOTE = HERE / "runpod_w8_logikbench_conversion_remote_v1.py"
MANIFEST = HERE / "RUNPOD-W8-LOGIKBENCH-CONVERSION-UPLOAD-MANIFEST-V1-20260830.json"
BUNDLE = HERE / "RUNPOD-W8-LOGIKBENCH-CONVERSION-UPLOAD-BUNDLE-V1-20260830.zip"
...
def main() -> int:
    ...
    manifest = {
        "schema": "cm-runpod-w8-logikbench-conversion-upload-manifest/v1",
        ...
        "private_project_files": [REMOTE.name, "W8-LOGIKBENCH-ACQUISITION.json",

"""One separately authorized P5-CLI-corrected comparative native scout."""
import argparse
import base64
...
OUT = HERE / "http-native-scout-p5-cli-retry-execute-001"
...
REMOTE_CODE_PATH = HERE / "runpod_native_scout_remote_v3.py"
base.REMOTE_CODE = REMOTE_CODE_PATH.read_text(encoding="utf-8")
base.OUT = OUT
BOOTSTRAP_PATH = HERE / "http_native_scout_bootstrap_v2.py"
MANIFEST_PATH = HERE / "RUNPOD-NATIVE-SCOUT-UPLOAD-MANIFEST-V5-20260829.json"
PROPOSAL_PATH = HERE / "RUNPOD-NATIVE-SCOUT-P5-CLI-RETRY-PROPOSAL-20260829.md"
AUTHORIZATION_PATH = HERE / "HTTP-NATIVE-SCOUT-P5-CLI-RETRY-AUTHORIZED-20260829.json"
...
def save_evidence(log):
    ...
    if (
        validation.get("junit_testcases") != {"tests": 60, "failures": 0, "errors": 0, "skipped": 0}
        or type(junit_metadata.get("tests")) is not int
        or junit_metadata.get("tests", 0) < 60

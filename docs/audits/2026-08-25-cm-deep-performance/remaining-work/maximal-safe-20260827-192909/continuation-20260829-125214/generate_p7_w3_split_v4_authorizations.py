"""Generate the four exact W3 development-partition authorization records once."""
...
RECORDED_UTC = "2026-08-30T07:30:00Z"
PARTITIONS = {
    "ir-development-a": ("p7-ir", 0, 17, 68, "d9d75d3b166749db07e430ac3bd8e3e8e8df1879e775d0a31829c212241e7e39"),
    ...
    for partition_id, (policy, offset, cases, cells, remote_sha256) in PARTITIONS.items():
        record = {
            ...
            "authorization_basis": (
                ...
                "the uploaded 96-file payload remains byte-identical to the exact bundle explicitly "
                "authorized and already disclosed; V4 derives only a functional subset on the pod"
            ),
            "one_create": True,
            ...
            "chunk_bytes": 262144,
            "proposal_sha256": "d41dea01166057c21ce809313cd43d3e07efdfed8e007f9454bfa9304926d00f",
            ...
            "controller_sha256": "59bb51ccb7a7ecc51436905366201363778dd7934ba15b183c61658c9c344b55",
            "preflight_sha256": "122e9d3d19227419cb53d4f95ad38b75653797816b49cc56aab302a1879bcc59",
        ...
        path = HERE / ("HTTP-P7-W3-SPLIT-" + partition_id.upper() + "-V4-AUTHORIZED-20260830.json")

"""V4 one-create controller for one exact-96 P7 W3 development partition."""
import argparse
import base64
...
SHARDS = {
    "ir-development-a": {"policy": "p7-ir", "role": "development", "cases": 17, "cells": 68,
                         "offset": 0, "limit": 17, "code": "irda", "out": "p7-w3-split-ir-development-a-v4-001",
                         "remote": "runpod_p7_w3_split_remote_v4_ir_development_a.py"},
    "ir-development-b": {"policy": "p7-ir", "role": "development", "cases": 17, "cells": 68,
                         "offset": 17, "limit": 17, "code": "irdb", "out": "p7-w3-split-ir-development-b-v4-001",
                         "remote": "runpod_p7_w3_split_remote_v4_ir_development_b.py"},
    "relation-development-a": {"policy": "p7-relation", "role": "development", "cases": 17, "cells": 85,
                               "offset": 0, "limit": 17, "code": "rda", "out": "p7-w3-split-relation-development-a-v4-001",
                               "remote": "runpod_p7_w3_split_remote_v4_relation_development_a.py"},
    "relation-development-b": {"policy": "p7-relation", "role": "development", "cases": 17, "cells": 85,
                               "offset": 17, "limit": 17, "code": "rdb", "out": "p7-w3-split-relation-development-b-v4-001",
                               "remote": "runpod_p7_w3_split_remote_v4_relation_development_b.py"},
}
...
SHARD["name_prefix"] = "cm-p7-w3s4-" + SHARD["code"]
...
PROPOSAL_PATH = HERE / "RUNPOD-P7-W3-DEVELOPMENT-SPLIT-V4-PROPOSAL-20260830.md"
AUTHORIZATION_PATH = HERE / ("HTTP-P7-W3-SPLIT-" + SHARD_ID.upper() + "-V4-AUTHORIZED-20260830.json")
PARTITION_VALIDATION_PATH = HERE / "P7-W3-SPLIT-V4-OFFLINE-VALIDATION.json"
...
def require_authorization():
    ...
    expected = {
        "schema": "cm-runpod-p7-w3-split-authorization/v4",
        "authorized": True,
        "one_create": True,
        ...
        "prior_attempt_pod_ids": ["1xh6csc4oxy067", "2fzt8mu6ji6nmw", "r044pqp2vgp7cy", "6mlqn19hnco1b0", "d9z39u7pzvbju8", "pnpc0c0t6gu358", "9xjz22tif2ctrv", "alu08d0mlf02ba", "1uqsgeb7vpzihb"],

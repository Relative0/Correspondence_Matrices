"""Fail-closed RP-D0 Run 2 for the authorized pinned astutils source build."""
...
campaign.OUT_DIR = CAMPAIGN_ROOT / "runpod_dependency_feasibility_run2"
campaign.CAMPAIGN_NAME = "CM optional dependency feasibility RP-D0 Run 2 2026-08-26"
campaign.WORKER_FILENAME = "cm_dependency_runpod_worker_run2_2026_08_26.py"
campaign.AUDIT_FILENAME = "dependency_runpod_audit_run2_2026_08_26.json"
campaign.N_PODS = 1
campaign.TOTAL_BUDGET_USD = 0.25
campaign.PRIOR_ATTEMPT_COST_RESERVE_USD = 0.000765
...
campaign.ARCHIVE_PATHS = (
    "deliverables_n22_24/cm_dependency_runpod_campaign_run2_2026_08_26.py",
    "deliverables_n22_24/cm_dependency_runpod_worker_run2_2026_08_26.py",
    "docs/audits/2026-08-25-cm-deep-performance/remaining-work/campaign-20260826-154541/PREREGISTRATION-RPD0-RUN2.md",
...
def _make_archive(temp_dir: Path) -> tuple[Path, dict]:
    ...
    with zipfile.ZipFile(archive_path, "w", zipfile.ZIP_DEFLATED) as archive:
        ...
        archive.writestr("rpd0_run2_snapshot_manifest.json", manifest)
...
def _inventory(label: str) -> int:
    if label not in {"run2_preflight", "run2_postflight"}:
        raise SystemExit("inventory label must be run2_preflight or run2_postflight")

...
with (out / "CM_FABLE_wrapper_stats300_t16_raw.csv").open("w", newline="", encoding="utf-8") as f:
    w = csv.DictWriter(f, fieldnames=list(raw[0])); w.writeheader(); w.writerows(raw)
with (out / "CM_FABLE_wrapper_stats300_t16_summary.csv").open("w", newline="", encoding="utf-8") as f:

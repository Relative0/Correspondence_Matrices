...
def full_output_est_bytes(n, n_vars_env):
    width_bytes = (1 << n) // 8
    # env masks + ~18 words scratch buffers + a few transient bigints
    return n_vars_env * width_bytes + 24 * width_bytes
...
def run_campaign():
    ...
    try:
        ...
        TRIALS_A = {16: 6, 18: 6, 20: 4, 22: 3, 24: 3, 26: 2, 28: 2, 30: 1, 32: 1}
        for n in (16, 18, 20, 22, 24, 26, 28, 30, 32):
            ...
            if est > 0.55 * ram_now:
                ...
                continue
            use_bigint = n <= 26  # bigint full-output beyond 26 is minutes/eval

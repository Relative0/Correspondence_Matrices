...
def configure(attempt, profile):
    ...
    transport.REMOTE_CODE = (ROOT / 'scripts/cm_fair_feature_model_remote_v2.py').read_text()
...
def run(attempt, out):
    ...
    try:
        ...
        assert digest(ROOT / 'scripts/cm_fair_feature_model_remote_v2.py') == frozen['remote_sha256']
...
def main():
    ...
    parser.add_argument('--profile', default='fair-feature-model-v2')

"""Record the user's exact results-Pod authorization locally."""
...
OUT = BASE / "results-authorization-001/RUNPOD_RESULTS_AUTHORIZATION.json"
...
def main():
    ...
    document = {
        "schema": "cm-benchmark-runpod-results-authorization/v1",
        "authorized": True,

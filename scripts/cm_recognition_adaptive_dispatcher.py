"""Run the frozen one-pass exact adaptive dispatcher experiment."""
...
from cmbench.recognition.adaptive_dispatcher_experiment import (
    DEFAULT_C10_RUN, DEFAULT_C6_RUN, DEFAULT_C7_RUN, AdaptiveConfig, run_adaptive_experiment,
)
...
def main(argv=None):
    ...
    result = run_adaptive_experiment(AdaptiveConfig(

"""Run the leakage-safe exact representation dispatcher experiment."""
...
from cmbench.recognition.exact_dispatcher_experiment import (
    DEFAULT_C6_RUN, DEFAULT_C7_RUN, ExactDispatcherConfig,
    run_exact_dispatcher_experiment,
)

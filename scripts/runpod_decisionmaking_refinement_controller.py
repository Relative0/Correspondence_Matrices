...
PROFILE = 'decisionmaking-refinement'
...
def configure(attempt, profile):
    ...
    transport.REMOTE_CODE = (ROOT / 'scripts/cm_decisionmaking_refinement_remote.py').read_text()
...
def run(attempt, out):
    ...
    try:
        ...
        assert digest(ROOT / 'scripts/cm_decisionmaking_refinement_remote.py') == frozen['remote_sha256']
...
def main():
    ...
    parser.add_argument('--profile', default='decisionmaking-refinement')

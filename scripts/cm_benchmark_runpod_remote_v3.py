...
CORE_SCREEN_CODE_B64 = "__CM_CORE_SCREEN_CODE_B64__"
CORE_SCREEN_PLAN_B64 = "__CM_CORE_SCREEN_PLAN_B64__"
...
def install_core_screen():
    code = base64.b64decode(CORE_SCREEN_CODE_B64, validate=True)
    plan = base64.b64decode(CORE_SCREEN_PLAN_B64, validate=True)
    if hashlib.sha256(code).hexdigest() != os.environ["CM_CORE_SCREEN_SHA256"]:
        raise RuntimeError("core-screen runner identity mismatch")
    if hashlib.sha256(plan).hexdigest() != os.environ["CM_CORE_SCREEN_PLAN_SHA256"]:

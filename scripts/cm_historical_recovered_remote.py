...
def main():
    ...
    try:
        ...
        write(OUT / 'transport/PLACEMENT.json', dict(
            ...
            historical_scope='Hash-exact restored source and unchanged verifiers, Python 3.13.15 Linux compatibility replay.'))
        ...
        for item in manifest['archives']:
            ...
            checked = run(item['destination'], [sys.executable, *plan['command'][1:],
                '--junitxml=' + str(OUT / 'transport' / (item['destination'] + '.xml'))],

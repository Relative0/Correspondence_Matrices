...
def run(attempt, out):
    ...
    try:
        ...
        created = time.time()
        state = dict(name='cm-diag-linux-' + uuid.uuid4().hex[:12], created_epoch=created,
...
def main():
    ...
    parser.add_argument('--profile', default='component-historical')
